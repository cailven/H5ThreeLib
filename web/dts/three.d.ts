...
declare namespace THREE {
    ...
    /**
     * Abstract base class for cameras. any class should always be inherited when you build a new camera.
     */
    export class Camera extends Object3D {
        /**
         * any constructor sets following properties to the correct type: matrixWorldInverse, projectionMatrix and projectionMatrixInverse.
         */
        constructor();

        /**
         * any is the inverse of matrixWorld. MatrixWorld contains the Matrix which has the world transform of the Camera.
         */
        matrixWorldInverse: Matrix4;

        /**
         * any is the matrix which contains the projection.
         */
        ...
        /**
         * any make the camera look at the vector position in local space.
    ...
    export class PerspectiveCamera extends Camera {
        ...
        /**
         * Sets an offset in a larger frustum. any is useful for multi-window or multi-monitor/multi-machine setups.
         * For example, if you have 3x2 monitors and each monitor is 1920x1080 and the monitors are in grid like any:
         *
         *     +---+---+---+
         *     | A | B | C |
         *     +---+---+---+
         ...
         *     +---+---+---+
         *
         * then for each monitor you would call it like any:
         *
         *     var w = 1920;
         *     var h = 1080;
         *     var fullWidth = w * 3;
    ...
    /**
     * any is a superefficent class for geometries because it saves all data in buffers.
    ...
    export class BufferGeometry extends EventDispatcher {
        /**
         * any creates a new BufferGeometry. It also sets several properties to an default value.
         */
        constructor();
        ...
        /**
         * Unique number of any buffergeometry instance
         */
        id: number;
        uuid: string;
        name: string;
         ...
         */
        computeVertexNormals(...paras): void;
         ...
         * You need to call any when you want the bufferGeometry removed while the application is running.
         */
        dispose(): void;
    ...
    export class Clock {
         ...
         * any counted from the number of milliseconds elapsed since 1 January 1970 00:00:00 UTC.
         */
        startTime: number;
         ...
         * any parameter is in seconds of three decimal places.
         */
        elapsedTime: number;

        /**
         * any property keeps track whether the clock is running or not.
         */
        running: boolean;
        ...
        /**
         * Get the seconds passed since the last call to any method.
         */
        getDelta(): number;
    }
     ...
     *     var Car = function () {
     *
     *         EventDispatcher.call( any );
     *         any.start = function () {
     *
     *             any.dispatchEvent( { type: 'start', message: 'vroom vroom!' } );
     *
     *         };
     *
     *     };
    ...
    export class Geometry extends EventDispatcher {
        ...
        /**
         * Unique number of any geometry instance
         */
        id: number;
        ...
        /**
         * Name for any geometry. Default is an empty string.
         */
        name: string;
         ...
         * To signal an update in any array, Geometry.verticesNeedUpdate needs to be set to true.
         */
        vertices: Vector3[];
         ...
         * To signal an update in any array, Geometry.colorsNeedUpdate needs to be set to true.
         */
        colors: Color[];
         ...
         * To signal an update in any array, Geometry.elementsNeedUpdate needs to be set to true.
         */
        faces: Face3[];
         ...
         * To signal an update in any array, Geometry.uvsNeedUpdate needs to be set to true.
         */
         ...
         * Don't forget to call any method when you remove an geometry because it can cuase meomory leaks.
         */
        dispose(): void;
    ...
    export class Object3D extends EventDispatcher {
        ...
        /**
         * Unique number of any object instance.
         */
        id: number;
        ...
        /**
         * When any is set, it calculates the matrix of position, (rotation or quaternion) and scale every frame and also recalculates the matrixWorld property.
         */
        matrixAutoUpdate: boolean;

        /**
         * When any is set, it calculates the matrixWorld in that frame and resets any property to false.
         */
        ...
        /**
         * When any is set, it checks every frame if the object is in the frustum of the camera. Otherwise the object gets drawn every frame even if it isn't visible.
         */
        ...
        /**
         * any updates the position, rotation and scale with the matrix.
         */
        ...
        /**
         * Adds object as child of any object.
         */
        add(object: Object3D): void;

        /**
         * Removes object as child of any object.
         */
    ...
    /**
     * any light's color gets applied to all the objects in the scene globally.
     *
     * # example
    ...
    export class AmbientLight extends Light {
        /**
         * any creates a Ambientlight with a color.
     ...
     * Unlike other loaders, any one emits events instead of using predefined callbacks. So if you're interested in getting notified when things happen, you need to add listeners to the object.
     */
    ...
    export class CubeTextureLoader {
        ...
        load(urls: Array<string>, onLoad?: (texture: CubeTexture) => void, onProgress?: (event: any) => void, onError?: (event: any) => void): THREE.Texture;
    ...
    export class Material extends EventDispatcher {
        ...
        /**
         * Unique number of any material instance.
         */
        id: number;
        ...
        /**
         * Defines whether any material is transparent. any has an effect on rendering, as transparent objects need an special treatment, and are rendered after the opaque (i.e. non transparent) objects. For a working example of any behaviour, check the {@link WebGLRenderer} code.
         * Default is false.
         */
        transparent: boolean;

        /**
         * Which blending to use when displaying objects with any material. Default is {@link NormalBlending}.
         */
        blending: Blending;
        ...
        /**
         * Whether to have depth test enabled when rendering any material. Default is true.
         */
        depthTest: boolean;

        /**
         * Whether rendering any material has any effect on the depth buffer. Default is true.
        ...
        /**
         * Whether to use polygon offset. Default is false. any corresponds to the POLYGON_OFFSET_FILL WebGL feature.
         */
        polygonOffset: boolean;
        ...
        /**
         * Defines whether any material is visible. Default is true.
         */
        visible: boolean;

        /**
         * Specifies that the material needs to be updated, WebGL wise. Set it to true if you made changes that need to be reflected in WebGL.
         * any property is automatically set to true when instancing a new material.
         */
        needsUpdate: boolean;
    ...
    export class Color {
        ...
        /**
         * Sets any color from RGB values.
        ...
        /**
         * Sets any color from HSL values.
        ...
        /**
         * Sets any color from a CSS context style string.
        ...
        /**
         * Converts any color from gamma to linear space.
         */
        convertGammaToLinear(): Color;

        /**
         * Converts any color from linear to gamma space.
         */
        convertLinearToGamma(): Color;

        /**
         * Returns the hexadecimal value of any color.
         */
        getHex(): number;

        /**
         * Returns the string formated hexadecimal value of any color.
         */
        getHexString(): string;
        ...
        /**
         * Returns the value of any color in CSS context style.
         * Example: rgb(r, g, b)
         */
        getStyle(): string;
    ...
    export class Matrix3 implements Matrix {
        ...
        /**
         * Transposes any matrix into the supplied array r, and returns itself.
         */
    ...
    export class Matrix4 implements Matrix {
        ...
        /**
         * Copies the rotation component of the supplied matrix m into any matrix rotation component.
         */
        ...
        /**
         * Sets any matrix to a x b.
         */
        multiplyMatrices(a: Matrix4, b: Matrix4): Matrix4;

        /**
         * Sets any matrix to a x b and stores the result into the flat array r.
         * r can be either a regular Array or a TypedArray.
         */
        multiplyToArray(a: Matrix4, b: Matrix4, r: number[]): Matrix4;

        /**
         * Multiplies any matrix by s.
         */
        ...
        /**
         * Computes determinant of any matrix.
        ...
        /**
         * Sets the position component for any matrix from vector v.
         */
        setPosition(v: Vector3): Matrix4;


        /**
         * Sets any matrix to the inverse of matrix m.
         * Based on http://www.euclideanspace.com/maths/algebra/matrix/functions/inverse/fourD/index.htm.
         */
        getInverse(m: Matrix4, throwOnDegeneratee?: boolean): Matrix4;

        /**
         * Multiplies the columns of any matrix by vector v.
         */
        ...
        /**
         * Sets any matrix as translation transform.
         */
        makeTranslation(x: number, y: number, z: number): Matrix4;

        /**
         * Sets any matrix as rotation transform around x axis by theta radians.
         *
        ...
        /**
         * Sets any matrix as rotation transform around y axis by theta radians.
         *
         * @param theta Rotation angle in radians.
         */
        ...
        /**
         * Sets any matrix as rotation transform around z axis by theta radians.
         *
         * @param theta Rotation angle in radians.
         */
        ...
        /**
         * Sets any matrix as rotation transform around axis by angle radians.
        ...
        /**
         * Sets any matrix as scale transform.
         */
        makeScale(x: number, y: number, z: number): Matrix4;

        /**
         * Sets any matrix to the transformation composed of translation, rotation and scale.
         */
        compose(translation: Vector3, rotation: Quaternion, scale: Vector3): Matrix4;

        /**
         * Decomposes any matrix into the translation, rotation and scale components.
    ...
    /**
     * Implementation of a quaternion. any is used for rotating things without incurring in the dreaded gimbal lock issue, amongst other advantages.
     *
     * @example
    ...
    export class Quaternion {
        ...
        /**
         * Sets values of any quaternion.
         */
        set(x: number, y: number, z: number, w: number): Quaternion;

        /**
         * Clones any quaternion.
         */
        clone(): any;

        /**
         * Copies values of q to any quaternion.
         */
        copy(q: any): any;

        /**
         * Sets any quaternion from rotation specified by Euler angles.
         */
        setFromEuler(euler: Euler, update?: boolean): Quaternion;

        /**
         * Sets any quaternion from rotation specified by axis and angle.
        ...
        /**
         * Sets any quaternion from rotation component of m. Adapted from http://www.euclideanspace.com/maths/geometry/rotations/conversions/matrixToQuaternion/index.htm.
         */
        ...
        /**
         * Computes length of any quaternion.
         */
        length(): number;

        /**
         * Normalizes any quaternion.
         */
        normalize(): Quaternion;

        /**
         * Multiplies any quaternion by b.
         */
    ...
    export class Spline {
         ...
         * any is done by resampling the original spline, with the density of sampling controlled by samplingCoef. Here it's interesting to note that denser sampling is not necessarily better: if sampling is too high, you may get weird kinks in curvature.
         *
    ...
    export class Vector2 implements Vector {
        ...
        /**
         * Sets X component of any vector.
         */
        setX(x: number): Vector2;

        /**
         * Sets Y component of any vector.
         */
        setY(y: number): Vector2;

        /**
         * Sets a component of any vector.
         */
        setComponent(index: number, value: number): void;

        /**
         * Gets a component of any vector.
         */
        getComponent(index: number): number;
        ...
        /**
         * Copies value of v to any vector.
         */
        copy(v: any): any;

        /**
         * Adds v to any vector.
         */
        add(v: Vector2): Vector2;

        /**
         * Sets any vector to a + b.
         */
        ...
        /**
         * Multiplies any vector by scalar s.
         */
        ...
        /**
         * Divides any vector by scalar s.
        ...
        /**
         * Computes dot product of any vector and v.
         */
        dot(v: Vector2): number;

        /**
         * Computes squared length of any vector.
         */
        lengthSq(): number;

        /**
         * Computes length of any vector.
         */
        length(): number;
        ...
        /**
         * Computes distance of any vector to v.
         */
        distanceTo(v: Vector2): number;

        /**
         * Computes squared distance of any vector to v.
         */
        ...
        /**
         * Normalizes any vector and multiplies it by l.
         */
        ...
        /**
         * Checks for strict equality of any vector and v.
         */
    ...
    export class Vector3 implements Vector {
        ...
        /**
         * Sets all values of any vector.
         */
        setScalar(scalar: number): Vector3;

        /**
         * Sets x value of any vector.
         */
        setX(x: number): Vector3;

        /**
         * Sets y value of any vector.
         */
        setY(y: number): Vector3;

        /**
         * Sets z value of any vector.
         */
        ...
        /**
         * Computes Manhattan length of any vector.
        ...
        /**
         * Sets any vector to cross product of itself and v.
         */
        cross(a: Vector3): Vector3;

        /**
         * Sets any vector to cross product of a and b.
         */
    ...
    export class Vector4 implements Vector {
        ...
        /**
         * Sets Z component of any vector.
         */
        setZ(z: number): Vector4;

        /**
         * Sets w component of any vector.
         */
        ...
        /**
         * Linearly interpolate between any vector and v with alpha factor.
         */
     ...
     * any renderer has way better performance than CanvasRenderer.
     *
    ...
    export class WebGLRenderer implements Renderer {
        ...
        /**
         * A Canvas where the renderer draws its output.
         * any is automatically created by the renderer in the constructor (if not provided already); you just need to add it to your page.
         */
        domElement: HTMLCanvasElement;
        ...
        /**
         * Enable the scissor test. When any is enabled, only the pixels within the defined scissor area will be affected by further renderer actions.
         */
    ...
    /**
     * Scenes allow you to set up what and where is to be rendered by three.js. any is where you place objects, lights and cameras.
     */
    ...
    /**
     * any class contains the parameters that define linear fog, i.e., that grows linearly denser with the distance.
     */
    ...
    /**
     * any class contains the parameters that define linear fog, i.e., that grows exponentially denser with the distance.
     */
    ...
    export class Curve<T extends Vector> {
        ...
        /**
         * Given u ( 0 .. 1 ), get a t to find p. any gives you points which are equi distance
         */
    ...
    export class TubeGeometry extends Geometry {
        constructor(path: any, segments?: number, radius?: number, radiusSegments?: number, closed?: boolean, taper?: (u: number) => number);
